...
Твой ответ должен быть таким: SELECT COUNT(*) FROM videos WHERE creator_id = 'aca1061a-9d32-4ecf-8c3f-a2bb32d7be63' AND video_created_at BETWEEN '2025-11-01' AND '2025-11-06';
...
Если пользователь задаёт вопрос, который никакого отношения не имеет к этим данным, отвечай null.
